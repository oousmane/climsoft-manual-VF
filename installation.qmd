...
Si l'installation de WRPlot semble prendre trop de temps, vérifiez la présence d'une deuxième boîte de dialogue d'installation qui peut être minimisée en bas de la barre des tâches et qui requiert votre approbation.
...
Au besoin si vous souhaitez (ré)installer MariaDB ou WRPLot plutard, les fichiers d'installation de ces applications sont contenus dans le sous-dossier "Bin" du dossier d'installation de Climsoft.
